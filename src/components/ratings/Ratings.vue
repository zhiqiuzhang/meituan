<template>
  <div class="ratings" ref="ratingView">
    <div class="ratings-wrapper">
      ...
      <div class="content" v-if="ratings.tab">
        <div class="rating-select">
          <span 
            class="item"
            @click="selectType(0)"
            :class="{'active':selectCurrentType == 0}"
          ...
          <span 
            class="item" 
            @click="selectType(1)"
            :class="{'active':selectCurrentType == 1}"
             >
          ...
          <span 
            class="item" 
            @click="selectType(2)"
            :class="{'active':selectCurrentType == 2}"
            >
            {{ratings.tab[2].comment_score_title}}
            <img v-show="selectCurrentType != 2" src="./img/icon_sub_tab_dp_normal@2x.png" />
            <img v-show="selectCurrentType == 2" src="./img/icon_sub_tab_dp_highlighted@2x.png" />
          </span>
        </div>
...
export default {
  ...
  computed: {
  	selectComments() {
  		if(this.selectCurrentType==ALL) {
  			return this.ratings.comments;
  		} else if(this.selectCurrentType==PICTURE) {
  			let arr=[];
